module.exports = {
    ...
    rules: {
        'linebreak-style': ['error', process.env.NODE_ENV === 'prod' ? 'unix' : 'windows'], // rule for windows OC
        'class-methods-use-this': 0,
        'class-methods-use-this-regexp/class-methods-use-this': [
            2,
            {
                exceptMethods: [
                    'blur',
        ...
        'jsdoc/newline-after-description': '2', //here was number(2);
        ...
        'sort-class-members/sort-class-members': [
            2,
            {
                ...
                groups: {
                    ...
                    handling: [{ type: 'method', static: false, name: '/^handle.+$/' }]
                },
